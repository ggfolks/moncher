    ...
    const cameraId = this._cameraId = domain.add({
      components: {
        ...
        graph: {
          ...
          click0: {type: "mouseButton", button: 0},
          click1: {type: "mouseButton", button: 1},
          click: {type: "or", inputs: ["click0", "click1"]},
          touched: {type: "and", inputs: ["hover", "click"]},
          viewMovement: {type: "Vector3.split", input: ["hover", "viewMovement"]},
          xDelta: {type: "multiply",
              inputs: ["touched", ["viewMovement", "x"], -CAMERA_MOVEMENT_FACTOR]},
          yDelta: {type: "multiply",
              inputs: ["touched", ["viewMovement", "y"], CAMERA_MOVEMENT_FACTOR]},
